...
const RecentWorkSection = ({ projects, onProjectSelect }) => {
  const items = projects.filter(p => p.pages?.includes('recent work'));

  return (
    <div style={{ padding: '100px 40px', backgroundColor: 'white', minHeight: 'calc(100vh - 50px)' }}>
      <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
        <h2 className="section-title" style={{ fontWeight: '900', textTransform: 'uppercase', letterSpacing: '0.2em', fontSize: '40px', marginBottom: '60px' }}>Recent Work</h2>
